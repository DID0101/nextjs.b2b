...
const resume = () => {
  return (
    <>
      <Head>
        <title>B2B Pixel | Portfolio</title>
        <meta
          name='description'
      ...
      <div className='max-w-[940px] mx-auto p-2 pt-[120px]'>
        ...
        <div className='bg-[#d0d4d6] my-4 p-4 w-full flex justify-between items-center'>
          <h2 className='text-center'>Our Portfolio of Clients</h2>
          <div className='flex'>
            <a
              href='https://www.linkedin.com/in/b2bpixel?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'
              target='_blank'
              rel='noreferrer'
            >
            ...
            <a
              href='https://www.instagram.com/b2bpixel?utm_source=qr&igsh=enFwMjlyMmoyZHNy'
              target='_blank'
              rel='noreferrer'
            >
